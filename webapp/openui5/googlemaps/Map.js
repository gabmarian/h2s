 ...
 * @license MIT
 */
sap.ui.define(["jquery.sap.global", "sap/ui/core/Control", "sap/ui/core/ResizeHandler", "google.maps", "./MapsApi", "./MapUtils",
		"./MapTypeId"
	],
	function (jQuery, Control, ResizeHandler, Gmaps, MapsApi, MapUtils, MapTypeId) {
		...
		Map.prototype.notifyAggregations = function (sEvent) {
			...
			var aAggregations = Object.keys(oAggregations).map(function (sKey) {
